...
Lighthouse generuje szczegółowe raporty zawierające zarówno numeryczne oceny, jak i konkretne rekomendacje dotyczące poprawy jakości aplikacji. Audyt został przeprowadzony na urządzeniu typu desktop (rozdzielczość 1280x720 pikseli), jego wyniki zaprezentowane są w tabeli \ref{tab:lighthouse-results}.
