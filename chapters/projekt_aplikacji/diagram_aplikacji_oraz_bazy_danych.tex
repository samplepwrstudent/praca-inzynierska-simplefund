...
W przypadku omawianej pracy zdecydowano się na prezentację tylko drugiego poziomu: kontenerów. Diagram (Rysunek \ref{fig:diagram_c4}) przedstawia główne elementy techniczne aplikacji: frontend, backend oraz zewnętrzne usługi, wraz z relacjami między nimi. 
