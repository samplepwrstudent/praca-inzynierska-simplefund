...
\lstdefinelanguage{TypeScript}{
  language=JavaScript,
  keywords={const, class, export, boolean, throw, implements, import, this, interface, 
  extends, public, private, protected, readonly, enum, type, namespace},
}

% Konfiguracja minted dla spisu listingów z kropkami
